...
/**
 * Unit tests for {@link TftpTcpProtocol} (client-side copy). Mirror of the
 * server module's tests — both copies must stay in lock-step so the wire
 * format cannot silently drift between client and server.
 */
